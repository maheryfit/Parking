...
<%
    ...
    String sessionUser = (String) request.getAttribute("session");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container">
          <a class="navbar-brand" href="/">
            <span>
              <img src="<%=url%>/assets/img/Logo-parking-clair.png" width="10px" alt="" srcset=""> 
            </span>
          </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="<%=url%>/assets/img/c-removebg-preview (1).png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Sécurité
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="<%=url%>/assets/img/c.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Temps
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="<%=url%>/assets/img/d.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Promotionnel
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="img-box">
                  ...
                  <a href="">
                    <img src="<%=url%>/assets/img/link.png" alt="">
                  </a>
                </div>
              </div>
              <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="img-box">
                  <img src="<%=url%>/assets/img/w-3.jpg" alt="">
                  <a href="">
                    <img src="<%=url%>/assets/img/link.png" alt="">
                  </a>
                </div>
              ...
              <div class="col-sm-6">
                <div class="img-box">
                  <img src="<%=url%>/assets/img/w-4.jpg" alt="">
                  <a href="">
                    <img src="<%=url%>/assets/img/link.png" alt="">
                  </a>
                </div>
  ...
  <section class="service_section layout_padding-bottom">
    <div class="container">
      ...
      <div class="box">
        <div class="img-box">
          <img src="<%=url%>/assets/img/.png" alt="">
      ...
      <div id="carouselExample2Indicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="box">
              <div class="img-box">
                <img src="<%=url%>/assets/img/client.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Mahery
      ...
      <div class="row">
        ...
        <div class="col-lg-2">
          ...
          <div class="info_link-box">
            ...
            <a href="">
              <img src="<%=url%>/assets/img/call.png" alt="">
              <span>+261 xxxxxxx</span>
            </a>
            <a href="">
              <img src="<%=url%>/assets/img/envelope.png" alt="">
          ...
          <div class="info_social">
            <div>
              <a href="">
                <img src="<%=url%>/assets/img/fb.png" alt="">
              </a>
            </div>
            <div>
              <a href="">
                <img src="<%=url%>/assets/img/github.png" alt="">
              </a>
            </div>
            <div>
              <a href="">
                <img src="<%=url%>/assets/img/insta.png" alt="">
              </a>
            </div>
          </div>
        </div>
